...
function findSectionIndices(markdown, heading) {
...
function applyAdd(markdown, heading, content) {
...
function applyUpdate(markdown, heading, content) {
    const indices = findSectionIndices(markdown, heading);
    if (!indices) {
...
function applyDelete(markdown, heading) {
    const indices = findSectionIndices(markdown, heading);
    if (!indices)
        return markdown;
    const lines = markdown.split('\n');
